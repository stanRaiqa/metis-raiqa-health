...
/**
 * Skincare How It Works Component
...
const treatmentSteps: ScrollStep[] = [
    {
        id: 1,
        title: 'Quiz',
...
export default function SkincareHowItWorks() {
    ...
    useMotionValueEvent(scrollYProgress, "change", (latest) => {
        const cardsBreakpoints = treatmentSteps.map((_, index) => index / treatmentSteps.length);
