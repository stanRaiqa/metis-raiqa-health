...
/**
 * Skincare Subscription Plans Component
...
const skincareSubscriptionPlans: SubscriptionPlan[] = [
    {
        id: 'prevention',
        name: 'Prevention',
        badge: 'Essential',
...
export default function SkincareSubscription() {
    return (
        <SubscriptionPlansLegacy
            ...
            plans={skincareSubscriptionPlans}
        />
    );
}
