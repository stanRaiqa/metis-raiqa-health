...
interface SexualHealthHeroSectionProps {
    imageSrc?: string;
    imageAlt?: string;
}

export default function SexualHealthHeroSection({
    imageSrc = "/images/Hero_Image.jpg",
    imageAlt = "Sexual health treatment for men"
}: SexualHealthHeroSectionProps) {
    return (
        <HeroSection
            title={
            ...
            description="The most effective solutions to keep and regrow sexual health, sorted over the phone and delivered direct and discreet. Real results seen by thousands of men."
            primaryButtonText="Take the Quiz"
            primaryButtonHref="/get-started?treatment=sexual-health"
