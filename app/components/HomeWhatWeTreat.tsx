...
/**
 * HomeWhatWeTreat Component
 * Section showcasing Metis physical wellness with embedded YouTube video
 * - Standard 32px (px-8) horizontal padding
 * - Max-width: 1280px
 * - Two-column layout with video on the right
 */
           ...
           >
            ...
            <div className="space-y-4">
              <Body1 className="text-brand-steel">
                Metis Raiqa Health is dedicated to transforming your physical wellness journey. 
                We combine cutting-edge health technology with personalized care to help you 
                achieve optimal physical health and maintain lifelong wellness. Our comprehensive 
                approach addresses every aspect of your physical well-being.
              </Body1>
